    ...
    class Chain
      ...
      def generate_links n
        ...
        if n.type == :block
          ...
          location = Solargraph::Source::Location.new(@filename, Source::Range.from_to(n.loc.expression.line, n.loc.expression.column, n.loc.expression.last_line, n.loc.expression.last_column))
