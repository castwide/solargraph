  ...
  module Pin
    class Parameter < LocalVariable
      ...
      def typify api_map
        ...
        # @sg-ignore Wrong argument type for Solargraph::ComplexType::UniqueType#self_to_type:
        #   dst expected Solargraph::ComplexType, received Solargraph::ComplexType, Solargraph::ComplexType::UniqueType
