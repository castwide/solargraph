...
include Enumerable
include Kernel
def self.original_resolv_getaddress(arg0);end
...
def original_resolv_bind(arg0, arg1);end
def original_resolv_connect(arg0, arg1);end
def connect(host, port);end
def original_resolv_send(*args);end
