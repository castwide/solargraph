...
def parallel_executor=(arg0);end
def backtrace_filter();end
def reporter();end
def info_signal();end
def info_signal=(arg0);end
def autorun();end
...
class Minitest::Parallel::Executor < Object
include Kernel
def <<(work);end
def size();end
def start();end
...
class Minitest::Runnable < Object
include Kernel
...
class Minitest::AbstractReporter < Object
include Mutex_m
include Kernel
def start();end
def report();end
...
def maglev?(*args);end
def mri?(*args);end
def rubinius?(*args);end
def windows?(*args);end
end
class Minitest::BacktraceFilter < Object
include Kernel
def filter(bt);end
end
...
def assert_output(*args);end
def capture_io();end
def assert_raises(*args);end
def flunk(*args);end
...
class Tempfile < #<Class:0x007f206bfc81f8>
include #<Module:0x007f206c036b58>
